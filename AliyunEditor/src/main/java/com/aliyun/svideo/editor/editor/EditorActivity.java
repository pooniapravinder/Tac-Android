...
public class EditorActivity extends FragmentActivity {
    ...
    private static final String NEXT_ACTIVITY_CLASS_NAME = "com.wookes.tac.ui.Post";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.glsurface_view).setClipToOutline(true);
        initData();
        ...
        editView.setmOnFinishListener(new AlivcEditView.OnFinishListener() {
            ...
            public void onComplete(AlivcEditOutputParam outputParam) {
                ...
                intent.putExtra(PublishActivity.KEY_PARAM_MUSIC_ID, mInputParam.getMusicId());
                //传入视频比列
                intent.putExtra(PublishActivity.KEY_PARAM_VIDEO_RATIO, outputParam.getVideoRatio());
                intent.putExtra(PublishActivity.KEY_PARAM_VIDEO_PARAM, outputParam.getVideoParam());
    ...
    private void initData() {
        ...
        String musicId = intent.getStringExtra(AlivcEditInputParam.INTENT_KEY_MUSIC_ID);
