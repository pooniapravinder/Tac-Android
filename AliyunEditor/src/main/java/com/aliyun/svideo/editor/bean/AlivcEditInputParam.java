...
public class AlivcEditInputParam {
    ...
    public static final String INTENT_KEY_MUSIC_ID = "musicId";
    ...
    public static final int RESOLUTION_ORIGINAL = 4;
    ...
    private AlivcEditInputParam() {
        ...
        this.mResolutionMode = RESOLUTION_ORIGINAL;
    ...
    public int getOutputVideoWidth() {
        ...
        switch (mResolutionMode) {
            ...
            case RESOLUTION_ORIGINAL:
                if (mediaInfos != null && mediaInfos.size() > 0) {
                    width = (int) (getMediaWidth(mediaInfos.get(0)));
                } else {
                    width = 540;
                }
                break;
    ...
    private float getMediaWidth(MediaInfo mediaInfo) {
        float videoWidth = 540;
        if (mediaInfo.mimeType.startsWith("video") || mediaInfo.filePath.endsWith("gif") || mediaInfo.filePath.endsWith("GIF")) {
            NativeParser parser = new NativeParser();
            parser.init(mediaInfo.filePath);
            try {
        ...
        return videoWidth > 540 ? 540 : videoWidth;
    ...
    public static class Builder {
        ...
        public Builder setMusicId(String mMusicId) {
            this.mParam.mMusicId = mMusicId;
            return this;
        }
