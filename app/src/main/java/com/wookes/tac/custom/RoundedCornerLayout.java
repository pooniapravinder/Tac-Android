...
public class RoundedCornerLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        float providedRadius = typedArray.getFloat(R.styleable.RoundedCornerLayout_layout_corner_radius, 0);
        typedArray.recycle();
        DisplayMetrics metrics = context.getResources().getDisplayMetrics();
        cornerRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, providedRadius, metrics);
