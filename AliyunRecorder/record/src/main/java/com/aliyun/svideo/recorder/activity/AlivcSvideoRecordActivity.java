...
public class AlivcSvideoRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.video_view_container).setClipToOutline(true);
        getData();
    ...
    private void initRecord() {
        ...
        if (mInputParam != null) {
            ...
            mVideoRecordView.setMusicPath(mInputParam.getMusicPath());
            //配置录制recorder
...
//                RecordCommon.copyRace(activity);
    ...
    private void getData() {
        ...
        String musicPath = intent.getStringExtra(AlivcRecordInputParam.INTENT_KEY_MUSIC_PATH);
        String musicId = intent.getStringExtra(AlivcRecordInputParam.INTENT_KEY_MUSIC_ID);
        //获取录制输入参数
    ...
    protected void onResume() {
        ...
        mVideoRecordView.setCompleteListener(new AliyunSVideoRecordView.OnFinishListener() {
            ...
            public void onComplete(final String path, int duration, int ratio) {
                ...
                intent.putExtra(AlivcEditInputParam.INTENT_KEY_FRAME, mInputParam.getFrame());
                intent.putExtra(AlivcEditInputParam.INTENT_KEY_RATION_MODE, ratio);
                intent.putExtra(AlivcEditInputParam.INTENT_KEY_GOP, mInputParam.getGop());
                intent.putExtra(AlivcEditInputParam.INTENT_KEY_QUALITY, mInputParam.getVideoQuality());
                intent.putExtra(AlivcEditInputParam.INTENT_KEY_RESOLUTION_MODE, mInputParam.getResolutionMode());
                intent.putExtra(AlivcEditInputParam.INTENT_KEY_CODEC, mInputParam.getVideoCodec());
                intent.putExtra(AlivcEditInputParam.INTENT_KEY_REPLACE_MUSIC, isUseMusic);
                intent.putExtra(AlivcEditInputParam.INTENT_KEY_WATER_MARK, false);
                intent.putExtra(AlivcEditInputParam.INTENT_KEY_MUSIC_ID, mInputParam.getMusicId());
                intent.putParcelableArrayListExtra(AlivcEditInputParam.INTENT_KEY_MEDIA_INFO, infoList);
    ...
    public static void startRecord(Context context, AlivcRecordInputParam recordInputParam) {
        ...
        intent.putExtra(AlivcRecordInputParam.INTENT_KEY_MUSIC_PATH, recordInputParam.getMusicPath());
        intent.putExtra(AlivcRecordInputParam.INTENT_KEY_MUSIC_ID, recordInputParam.getMusicId());
