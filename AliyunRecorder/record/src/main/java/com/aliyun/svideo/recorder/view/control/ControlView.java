...
public class ControlView extends RelativeLayout implements View.OnTouchListener {
    ...
    private ImageView aliyunChooseVideo;
    ...
    private void assignViews() {
        ...
        aliyunChooseVideo = findViewById(R.id.aliyun_choose_video);
    ...
    private class BackgroundTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ContentResolver contentResolver = aliyunChooseVideo.getContext().getContentResolver();
            String[] projection = {
            ...
            try (Cursor cursor = contentResolver.query(uri, projection, selection, null, MediaStore.Files.FileColumns.DATE_ADDED + " DESC LIMIT 1")) {
        ...
        protected void onPostExecute(String result) {
            ...
            DisplayMetrics displayMetrics = aliyunChooseVideo.getContext().getResources().getDisplayMetrics();
                new ImageLoaderImpl().loadImage(aliyunChooseVideo.getContext(), result,
                        new ImageLoaderOptions.Builder().override(displayMetrics.widthPixels / 5, displayMetrics.widthPixels / 5)
                                .skipMemoryCache()
                                .roundCorner()
                                .placeholder(new ColorDrawable(Color.GRAY))
                                .build()
                ).into(aliyunChooseVideo);
        }
    }
    ...
    private void setViewListener() {
        ...
        aliyunChooseVideo.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (FastClickUtil.isFastClick()) {
                    return;
    ...
    private void updateBottomView() {
        if (isEffectSelViewShow) {
            ...
            if (recordState == RecordState.STOP) {
                ...
                aliyunChooseVideo.setVisibility(INVISIBLE);
            }
        }
    ...
    private void updateDeleteView() {
        ...
        if (!hasRecordPiece || recordState == RecordState.RECORDING
            ...
            aliyunChooseVideo.setVisibility(VISIBLE);
        } else {
            aliyunDelete.setVisibility(VISIBLE);
            aliyunChooseVideo.setVisibility(GONE);
        }
    }
