...
public class AlivcRecordInputParam {
    ...
    public static final String INTENT_KEY_MUSIC_PATH = "mMusicPath";
    public static final String INTENT_KEY_MUSIC_ID = "mMusicId";
    ...
    public static final int DEFAULT_VALUE_MIN_DURATION = 5 * 1000;
    ...
    public static class Builder {
        ...
        public Builder setMusicPath(String mMusicPath) {
            this.mParam.mMusicPath = mMusicPath;
            return this;
        }
