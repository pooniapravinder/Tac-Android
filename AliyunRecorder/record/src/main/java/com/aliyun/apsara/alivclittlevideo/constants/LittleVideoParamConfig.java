...
public class LittleVideoParamConfig {
    ...
    public static class Recorder {
        ...
        /**
         * maxDuration: 最大时长: 60000ms
         */
        public static final int MAX_DURATION = 60000;
        /**
         * minDuration: 最小时长: 5000ms
         */
    ...
    public static class Crop {
         ...
         */
        public static final int MAX_VIDEO_DURATION = 60 * 1000;
    ...
    public static class Editor {
        ...
        public static final int RESOLUTION_MODE  = AlivcEditInputParam.RESOLUTION_ORIGINAL;

        public static final int VIDEO_CRF  = 23;
         ...
         * VIDEO_GOP: 125
         */
        public static final int VIDEO_GOP  = 250;
     ...
     * 视频列表缓存目录
     */
    public static String DIR_CACHE = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Wookes Tac/cache";
    /**
     * 视频下载目录
     */
    public static String DIR_DOWNLOAD = "Wookes Tac/download/";
    /**
     * 视频合成目录
     */
    public static String DIR_COMPOSE = "Wookes Tac/compose/";
